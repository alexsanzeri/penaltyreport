...
<body>
	...
	<div class="container">
		...
		<h1 class="mt-4 mb-3">
			...
			Football <small>2019 Edition  NEW FORMAT THIS YEAR!</small>
		</h1>
		...
		<div class="row">
			...
			<div class="col-lg-6">
				...
				<p>Check out the latest editions of BCS National Championship
					...
					Officiating for High School Football. Bill, along with high school and
					NCAA official Tim Kiefer, provides valuable insight,
					breakdown, and analysis of rules, positioning, and mechanics in
					actual high school football games. This year's video is presented in an 
					all new format with practical examples and discussion.  Bill and Tim
					focus on three areas, Rules, Mechanic, and Judgment.
                                        Bill has officiated for over 40 years including 20 years in the Big Ten
					and extensive officiating experience include appearances in 10
					major bowl games, a NCAA National Championship game and was
                                        awarded the NASO/Referee Magazine 2013 Golden Whistle.
					Tim has officiated High School and College for over 20 years
                                        with numerous State Championships and NCAA division one games.

                                        3 ways to purchase the video this year.  You can purchase a DVD, 
					a flash drive or the online streaming version by clicking the links below  
                                        or on the video on the left.  You can also subscribe to the MIBTonline.com
					online virtual association and have full access to this year's video as 
					well as the last three years.  Buy or Subscribe Now!</p>
				...
				<form action="https://www.paypal.com/cgi-bin/webscr" method="post"
					...
					<form action="https://www.paypal.com/cgi-bin/webscr" method="post"
						...
						<input type="hidden" name="cmd" value="_s-xclick"> <input
							type="hidden" name="hosted_button_id" value="WDYXW2X9FEGZN">

						<table>

							<tr>
								<td><input type="hidden" name="on0"
									value="Bill LeMonnier's Best Practices of Officiating DVD 2019"></td>
							</tr>
							<tr>
								<td><select name="os0">
