...
<html lang="en">
    ...
    <!-- Page Heading/Breadcrumbs -->
     ...
     <!-- Project One -->
      <div class="row">
        ...
        <div class="col-md-5">
          <h3>2019</h3>
          <p>Bill LeMonnier's third "Best Practices of Officiating for High School Football" 2019 Edition.</p>
 ...
 <!-- Project One -->
    ...
    <footer class="py-5 bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white">Copyright &copy; MIBT Media 2018-2019</p>
      </div>
      <!-- /.container -->
    </footer>
  </body>
